...
const profileLink = (name: string, service: 'x' | 'hudl' | 'maxpreps') => {
  ...
  const domain = service === 'hudl' ? 'hudl.com/profile' : 'maxpreps.com/athlete';
